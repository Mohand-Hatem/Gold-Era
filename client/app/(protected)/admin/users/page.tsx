...
export default function AdminUsersPage() {
  ...
  return (
    <div className="space-y-6 text-slate-900 dark:text-slate-100">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-200/80 dark:border-slate-800">
        <div>
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-0.5">
            Inspect registered accounts, change permission roles, or delete users.
          </p>
        </div>
      ...
      <Card className="p-4 border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-900 rounded-2xl shadow-xs">
      ...
      {/* Users Table */}
      <Card className="overflow-hidden border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-900 rounded-2xl shadow-xs">
        {isLoading ? (
          ...
          <EmptyState
            icon={<UserX className="h-8 w-8 text-blue-500" />}
            title={search ? "No matching users found" : "No users registered"}
            description={
              search
                ? `No accounts matching "${search}". Try searching another name or email.`
            ...
            <table className="w-full text-left text-sm">
              <thead className="bg-slate-50 dark:bg-slate-800/80 text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider border-b border-slate-200 dark:border-slate-800">
                <tr>
                  ...
                  <th className="py-3.5 px-4">Files Stored</th>
                    ...
                    >
                      ...
                      <td className="py-3.5 px-4">
                        <div className="flex items-center gap-3">
                          <div className="flex h-9 w-9 shrink-0 items-center justify-center overflow-hidden rounded-xl bg-blue-600 font-bold text-white text-xs shadow-xs">
                            {u.avatarUrl ? (
                              <img
                                src={u.avatarUrl}
                                alt={u.name}
                          ...
                          <div>
                            <div className="flex items-center gap-2">
                              ...
                              {isCurrent && (
                                <span className="rounded-md bg-blue-50 dark:bg-blue-950 px-1.5 py-0.5 text-[10px] font-bold text-blue-600 dark:text-blue-400">
                                  You
                                </span>
                              )}
                            </div>
                      ...
                      <td className="py-3.5 px-4 text-right">
                        <div className="flex items-center justify-end gap-1.5">
                          ...
                          >
                            <Shield className="h-3.5 w-3.5 mr-1 text-blue-600 dark:text-blue-400" />
                            Change Role
                          </Button>
                          <button
                            type="button"
                            ...
                            className="rounded-xl p-2 text-slate-400 dark:text-slate-500 hover:bg-red-50 dark:hover:bg-red-950/40 hover:text-red-600 dark:hover:text-red-400 transition-colors disabled:opacity-30 disabled:pointer-events-none cursor-pointer"
                          >
