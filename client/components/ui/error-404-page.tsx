...
export const NotFound = () => {
  return (
    <div className="min-h-screen w-full relative overflow-hidden flex items-center justify-center bg-[#1e3266]">
      ...
      <div className="z-10 text-center -translate-y-12 sm:-translate-y-20 px-4">
        <h1 className="text-7xl sm:text-9xl font-extrabold text-white mb-4 tracking-tight drop-shadow-md">
          404
        </h1>
        <p className="text-white/90 text-lg sm:text-xl mb-8 max-w-[600px] w-[90%] mx-auto font-medium leading-relaxed drop-shadow-xs">
          Oops! The page you&apos;re looking for seems to be lost in the clouds.
        </p>
        <Link
          href="/"
          className="inline-flex items-center justify-center rounded-xl bg-white px-8 py-3.5 text-sm font-bold text-[#1e3266] hover:bg-white/90 shadow-xl transition-all duration-200 active:scale-95"
        >
          Return Home
        </Link>
      </div>
